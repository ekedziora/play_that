...
import com.mohiva.play.silhouette.impl.providers.oauth2.GoogleProfileParser
import play.api.libs.concurrent.Execution.Implicits.defaultContext
import play.api.libs.json.JsValue

class CustomGoogleProfileParser extends SocialProfileParser[JsValue, CustomSocialProfile] {

  val commonParser = new GoogleProfileParser
